...
Putting all of this together, the attractor state typically corresponds to a **vicious cycle** of negative affect (fear and depression) that short-circuits the motivational and cognitive control systems in the prefrontal cortex and basal ganglia, which in turn leads to more negative affect due to a reduced level of self-esteem, perceived self-efficacy, and general feelings of loss of control and motivation to function.  The essential role of self-control and self-efficacy in the human motivational system was discussed in [@sec:ch-soc;@sec:ch-learn] --- from this basis, it should be clear that dysfunction in these core systems can really bring the whole self-model down.
